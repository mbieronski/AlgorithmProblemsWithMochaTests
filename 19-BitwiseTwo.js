...
// and return a final binary string that performed the 
// bitwise AND operation on both strings. A bitwise AND 
// operation places a 1 in the new string where there is 
// a 1 in both locations in the binary strings, otherwise 
// it places a 0 in that spot. For example: if strArr is 
